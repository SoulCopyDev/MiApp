...
export default function World6Level3({ navigation: propsNavigation, setAllowBack }: LevelProps) {
  ...
  const theorySteps = new Set([0, 1, 4, 5, 10, 12, 13, 15, 17]);
  ...
  const renderTheory1 = () => (
    <View>
      <View style={[styles.tag, { backgroundColor: '#eef2ff' }]}><Text style={[styles.tagText, { color: '#4338ca' }]}>Nivel 33 · 19 módulos</Text></View>
  ...
  const renderCompletion = () => (
    <View style={{ alignItems: 'center', padding: 20 }}>
      ...
      <Text style={{ fontSize: 12, color: '#9ca3af', marginBottom: 6 }}>Nivel 33 de 36</Text>
