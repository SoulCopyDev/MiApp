...
export default function World2Level1({ navigation: propsNavigation, setAllowBack }: LevelProps) {
  ...
  const renderTheory1 = () => (
    <View>
      <View style={[styles.tag, { backgroundColor: '#eef2ff' }]}><Text style={[styles.tagText, { color: '#4338ca' }]}>Nivel 7 · 20 módulos</Text></View>
  ...
  const renderCase = () => (
    <View>
      ...
      <Text style={styles.bodyText}>Valentina, 14 años. Necesitaba analizar 30 opiniones de usuarios de una app.</Text>
